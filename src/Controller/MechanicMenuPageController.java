...
public class MechanicMenuPageController implements Initializable {
    ...
    @FXML
    public void ComplaintButtonPressed(ActionEvent event) throws IOException{
        Parent ManageUserScoot = FXMLLoader.load(getClass().getResource("../View/MechanicManageComplaints.fxml"));
        Scene ManageUserScootScene = new Scene(ManageUserScoot);
